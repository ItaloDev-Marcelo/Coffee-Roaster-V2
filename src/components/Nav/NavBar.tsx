...
const NavBar = ({handleNav, type}:NavBarProps) => {
  return (
    <nav className='bg-gray-200  lg:bg-transparent w-full h-screen lg:h-25 p-5 flex
     fixed top-0 lg:relative flex-col items-start justify-start lg:px-12 2xl:mt-3 2xl:px-12  lg:flex-row lg:justify-between lg:items-center'>
       ...
       <div className='p-2'>
         ...
         <ul  className='flex flex-col items-center  justify-center w-screen
           mt-50 md:mt-25 lg:mt-0  lg:w-90 2xl:w-110 px-2  lg:flex-row md:items-center'>
            {
