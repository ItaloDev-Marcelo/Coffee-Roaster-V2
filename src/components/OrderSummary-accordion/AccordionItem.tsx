        ...
        <div>
            <div className='header flex flex-row   h-10 items-center my-5' onClick={() => handleAccordion(index)}>
             <div className='flex flex-row justify-between items-center  w-full'>
              <div className='cursor-pointer'> <p className='mr-2.5 text-1.7xl text-cyan-900 font-bold'><span className={accordionOpen == index ? 'text-green-700' : ''}>{data.accordionTitle}</span></p> </div>
